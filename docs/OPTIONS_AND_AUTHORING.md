...
| Game | `pterodactyl` | Minecraft Java, Paper and Bedrock, Terraria and Valheim are curated profiles created by `stackkit setup game`. Wings holds a governed Docker lifecycle-owner approval (ADR-0043); world backups are crash-consistent until a game quiesce hook exists. |
