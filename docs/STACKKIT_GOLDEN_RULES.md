...
12. No StackKit workflow job, test command, generated readiness wait, or manual release gate may wait longer than 15 minutes. Raising timeouts to avoid failures is forbidden; slow gates must fail fast with diagnostics, be split into bounded phases, or be redesigned.
