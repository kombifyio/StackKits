...
**Pairs with:** [`docs/BACKUP-ARCHITECTURE.md`](../BACKUP-ARCHITECTURE.md).
...
Phases 1-3 are complete. Phase 4 has landed as a scaffold and Phase 5 lives in kombify-TechStack. Remaining rollout work is tracked in Beads.
