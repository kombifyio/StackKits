...
See Beads and [ROADMAP.md](../../ROADMAP.md) for active architecture-alignment work.

## Related Documents

- [docs/ARCHITECTURE.md](../ARCHITECTURE.md) - current implementation architecture
- [ROADMAP.md](../../ROADMAP.md) - generated roadmap read-view
