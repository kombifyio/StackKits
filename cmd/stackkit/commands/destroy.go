...
func init() {
	...
	removeCmd.Flags().StringVar(&removeV2ExecutionOptions.localChannelRef, "local-execution-channel", "", "Exact applied execution channel owned by this removal process")
