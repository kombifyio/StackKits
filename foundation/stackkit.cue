// Package foundation - shared StackKit composition schema
package foundation

// #FoundationStackKit is the shared schema Product StackKits extend.
#FoundationStackKit: {
	...
	// Optional, so existing specs stay valid (non-breaking). See foundation/placement.cue.
