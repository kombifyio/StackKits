...
type WorkloadOperations struct {
	native  runtimeexecutorlocal.NativeWorkloadComposeOperations
	runtime Runtime
}
...
func (o *WorkloadOperations) ApplyWorkload(ctx context.Context, deployment runtimeexecutorlocal.SelectedPaaSWorkloadDeployment) (runtimeexecutorlocal.SelectedPaaSApplyReceipt, error) {
	if o == nil || o.native == nil {
		return runtimeexecutorlocal.SelectedPaaSApplyReceipt{}, errors.New("OpenTofu workload operations are not initialized")
	}
	if !runtimeexecutorlocal.GenerationTargetExecutesOpenTofu(deployment.GenerationTarget) {
		return o.native.ApplyWorkload(ctx, deployment)
	}
	if ctx == nil {
		return runtimeexecutorlocal.SelectedPaaSApplyReceipt{}, errors.New("OpenTofu workload operations require a context")
	}
	binary, providers, err := o.runtime.packagedTools()
	if err != nil {
		return runtimeexecutorlocal.SelectedPaaSApplyReceipt{}, err
	}
	workspace, err := filepath.Abs(o.runtime.WorkspaceRoot)
	if err != nil {
		return runtimeexecutorlocal.SelectedPaaSApplyReceipt{}, fmt.Errorf("resolve workspace: %w", err)
	}
	...
	if prepared.ProjectName != "stackkit-"+deployment.WorkloadRef+"-"+deployment.NodeRef ||
		...
		return runtimeexecutorlocal.SelectedPaaSApplyReceipt{}, errors.New("native workload project is not the stack graph runtime root")
	}
	...
	if err != nil || !bytes.Equal(applied, prepared.Compose) {
		return runtimeexecutorlocal.SelectedPaaSApplyReceipt{}, errors.New("OpenTofu-applied workload Compose file differs from the native project")
	}
	...
	return runtimeexecutorlocal.SelectedPaaSApplyReceipt{
...
func (o *WorkloadOperations) ObserveWorkload(ctx context.Context, deployment runtimeexecutorlocal.SelectedPaaSWorkloadDeployment) (runtimeexecutorlocal.SelectedPaaSWorkloadObservation, error) {
	if o == nil || o.native == nil {
		return runtimeexecutorlocal.SelectedPaaSWorkloadObservation{}, errors.New("OpenTofu workload operations are not initialized")
	}
	return o.native.ObserveWorkload(ctx, deployment)
}

// ValidateWorkloadObservation keeps the native semantic readback contract.
func (o *WorkloadOperations) ValidateWorkloadObservation(deployment runtimeexecutorlocal.SelectedPaaSWorkloadDeployment, observation runtimeexecutorlocal.SelectedPaaSWorkloadObservation) error {
	if o == nil || o.native == nil {
...
var _ runtimeexecutorlocal.SelectedPaaSWorkloadOperations = (*WorkloadOperations)(nil)
var _ runtimeexecutorlocal.SelectedPaaSWorkloadObservationValidator = (*WorkloadOperations)(nil)
