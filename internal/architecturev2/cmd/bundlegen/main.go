...
func writeProductKitsGo(repoFlag, bundleOut, relativeOutput string) error {
	...
	if err != nil {
		return fmt.Errorf("read generated product authority manifest: %w", err)
	}
	var generated manifest
	if err := json.Unmarshal(manifestBytes, &generated); err != nil {
		return fmt.Errorf("decode generated product authority manifest: %w", err)
	}
	if generated.SchemaVersion != bundleSchemaVersion || len(generated.Profiles) == 0 {
		return fmt.Errorf("generated product authority manifest has no valid product profiles")
	}
	slugs := make([]string, 0, len(generated.Profiles))
	for slug := range generated.Profiles {
		if strings.TrimSpace(slug) == "" {
			return fmt.Errorf("generated product authority manifest contains an empty profile slug")
		}
	...
	source.WriteString("// Authority bundle manifest " + contentHash(manifestBytes) + ".\n\n")
	source.WriteString("package productkits\n\n")
	source.WriteString("var active = []string{\n")
...
var rendererWorkloadImages = []struct {
	...
	{moduleID: "stackkits-emby-runtime", goPrefix: "emby"},
	{moduleID: "stackkits-passbolt-runtime", goPrefix: "passbolt"},
	{moduleID: "stackkits-passbolt-runtime", goPrefix: "passboltMariaDB", componentRef: "passbolt-mariadb"},
	{moduleID: "stackkits-nextcloud-runtime", goPrefix: "nextcloud"},
	{moduleID: "stackkits-nextcloud-runtime", goPrefix: "nextcloudPostgres", componentRef: "nextcloud-postgres"},
	{moduleID: "stackkits-nextcloud-runtime", goPrefix: "nextcloudValkey", componentRef: "nextcloud-valkey"},
	{moduleID: "stackkits-navidrome-runtime", goPrefix: "navidrome"},
	{moduleID: "stackkits-audiobookshelf-runtime", goPrefix: "audiobookshelf"},
	{moduleID: "stackkits-esphome-runtime", goPrefix: "esphome"},
	{moduleID: "stackkits-euro-office-runtime", goPrefix: "eurooffice"},
	{moduleID: "stackkits-mosquitto-runtime", goPrefix: "mosquitto"},
