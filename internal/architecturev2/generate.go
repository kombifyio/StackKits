...
//
//go:generate go run ./cmd/bundlegen -repo ../.. -out authority_bundle -product-kits-go-output internal/productkits/inventory_gen.go -renderer-images-go-output internal/architecturev2renderer/workload_images_gen.go
