...
var catalog = []Contract{
	...
	{ID: Apply, ToolName: "stackkit_apply", Title: "Apply", Description: "Apply the exact persisted plan after explicit local Owner approval.", Command: []string{"apply"}, Mutation: true, Destructive: true, Idempotent: false, OwnerApproval: true},
	...
	{ID: Logs, ToolName: "stackkit_logs", Title: "Logs", Description: "List local structured rollout logs.", Command: []string{"logs", "list"}, Idempotent: true},
