...
func NewExecutor(identity runtimeexecutor.ExecutorIdentity, binding nativehost.LocalTargetBinding, authority Authority, module ModuleBinding, runtime Runtime) *Executor {
...
func requireObservedHealth(observed nativehost.NativeComposeObservation, health []runtimeexecutor.HealthTarget) error {
...
type observationRecord struct {
	...
	tofuRun
	Verify *nativehost.NativeComposeObservation `json:"verify,omitempty"`
}
