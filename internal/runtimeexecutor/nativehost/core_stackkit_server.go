...
func releaseStackKitServerBinary() (string, error) {
	...
	return stackKitServerBinaryBeside(executable)
}

// stackKitServerBinaryBeside returns the stackkit-server shipped beside one
// stackkit executable of a release: the running CLI for Apply, or the
// release a coordinated rollback restores.
func stackKitServerBinaryBeside(executable string) (string, error) {
