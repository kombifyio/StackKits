...
const (
	...
	ErrExecutorFailed      ErrorCode = "executor_failed"
	ErrVerifierMissing     ErrorCode = "verifier_not_implemented"
	ErrEvidenceSetMismatch ErrorCode = "apply_evidence_set_mismatch"
	ErrDuplicateEvidence   ErrorCode = "duplicate_apply_evidence"
	ErrEvidenceFreshness   ErrorCode = "apply_evidence_freshness"
	ErrEvidenceUntrusted   ErrorCode = "apply_evidence_untrusted"
	ErrIO                  ErrorCode = "io"
)
