...
func Default() []Service {
	services := []Service{
		...
		},
		{
			...
			Icon: "&#8962;", Badge: "L3 \u00b7 Start", Section: "Platform", Order: 0, EnableVar: "enable_homepage", GuideURL: "https://docs.kombify.io/stackkits/apps/homepage", Default: true,
		},
		{
			...
			Icon: "&#128274;", Badge: "L1 \u00b7 ForwardAuth", Section: "Platform", Order: 20, EnableVar: "enable_tinyauth", GuideURL: "https://docs.kombify.io/stackkits/apps/tinyauth", Default: true,
		},
		{
			...
			Icon: "&#128100;", Badge: "L1 \u00b7 IdP", Section: "Platform", Order: 10, EnableVar: "enable_pocketid", GuideURL: "https://docs.kombify.io/stackkits/apps/pocketid", Default: true,
		},
		{
			...
			IdentityPolicy: IdentityPolicyForwardAuth, OwnerProvisioningPolicy: OwnerProvisioningRequired,
			Icon: "&#9889;", Badge: "L2 \u00b7 Reverse Proxy", Section: "Platform", Order: 30, EnableVar: "enable_traefik", GuideURL: "https://docs.kombify.io/stackkits/apps/traefik", Default: true,
		},
		{
			...
			IdentityPolicy: IdentityPolicyForwardAuth, OwnerProvisioningPolicy: OwnerProvisioningRequired,
			Icon: "&#128640;", Badge: "L2 \u00b7 PaaS", Section: "Platform", Order: 40, EnableVar: "enable_dokploy", GuideURL: "https://docs.kombify.io/stackkits/apps/overview", Default: false,
		},
		{
			...
			Icon: "&#9881;", Badge: "L2 \u00b7 PaaS", Section: "Platform", Order: 41, EnableVar: "enable_komodo", GuideURL: "https://docs.kombify.io/stackkits/apps/komodo", Default: false,
		},
		{
			...
			IdentityPolicy: IdentityPolicyForwardAuth, OwnerProvisioningPolicy: OwnerProvisioningRequired,
			Icon: "&#128202;", Badge: "L2 \u00b7 Monitoring", Section: "Platform", Order: 10, EnableVar: "enable_uptime_kuma", GuideURL: "https://docs.kombify.io/stackkits/apps/uptime-kuma", SetupPolicy: SetupPolicyAutomatic, Default: true,
		},
		{
			...
			IdentityPolicy: IdentityPolicyForwardAuth, OwnerProvisioningPolicy: OwnerProvisioningRequired,
			Icon: "&#129302;", Badge: "L2 \u00b7 Routing test", Section: "Platform", Order: 20, EnableVar: "enable_whoami", GuideURL: "https://docs.kombify.io/stackkits/apps/whoami", SetupPolicy: SetupPolicyAutomatic, Default: true,
		},
		{
			...
			Icon: "&#128272;", Badge: "L3 \u00b7 App login", Section: "Applications", Order: 30, EnableVar: "enable_vaultwarden", GuideURL: "https://docs.kombify.io/stackkits/apps/vaultwarden", SetupPolicy: SetupPolicyOnDemand, SetupActionLabel: "Automatisierter Bootstrap", Default: true,
		},
		{
			...
			IdentityPolicy: IdentityPolicySelfAuth, OwnerProvisioningPolicy: OwnerProvisioningNone,
			Icon: "&#127916;", Badge: "L3 \u00b7 App login", Section: "Applications", Order: 40, EnableVar: "enable_jellyfin", GuideURL: "https://docs.kombify.io/stackkits/apps/jellyfin", Default: false,
		},
		{
			...
			Icon: "&#128247;", Badge: "L3 \u00b7 App login", Section: "Applications", Order: 50, EnableVar: "enable_immich", GuideURL: "https://docs.kombify.io/stackkits/apps/immich", SetupPolicy: SetupPolicyOnDemand, SetupActionLabel: "Automatisierter Bootstrap", Default: true,
		},
		{
		...
		},
		{
			...
			IdentityPolicy: IdentityPolicyForwardAuth, OwnerProvisioningPolicy: OwnerProvisioningRequired,
			Icon: "&#128230;", Badge: "L2 \u00b7 Compose Manager", Section: "Platform", Order: 43, EnableVar: "enable_dockge", GuideURL: "https://docs.kombify.io/stackkits/apps/overview",
		},
		{
			...
			Icon: "&#128171;", Badge: "L2 \u00b7 PaaS", Section: "Platform", Order: 42, EnableVar: "enable_coolify", GuideURL: "https://docs.kombify.io/stackkits/apps/coolify",
		},
		{
			...
			IdentityPolicy: IdentityPolicyNone, OwnerProvisioningPolicy: OwnerProvisioningNone,
			Icon: "&#127760;", Badge: "L1 \u00b7 DNS", Section: "Platform", Order: 35, EnableVar: "enable_kombify_point", GuideURL: "https://docs.kombify.io/stackkits/apps/kombify-point",
		},
	}
